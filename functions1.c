...
*/
int printed_unsigned(va_list types, char buffer[],
 ...
 * @flags: calcs active flags
 * @width: get width
 * @precision: precision specicification
 * @size: size specifier
 * Return: num of chars printed
*/
int print_octal(va_list types, buffer[],
		int flags, int width, int precision, int size)
{
	int i = BUFF_SIZE - 2;
	unsigned long int num = va_arg(types, unsigned long int);
 ...
 * Return: num of chars printed
*/
int print_hexadecimal(va_list types, buffer[], int flags,
